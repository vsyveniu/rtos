...
void handle_led_on(struct arg_lit* first, struct arg_lit* second,
                   struct arg_lit* third, struct arg_lit* all)
{
    if (first->count)
    {
...
void handle_led_off(struct arg_lit* first, struct arg_lit* second,
                    struct arg_lit* third, struct arg_lit* all)
{
    if (first->count == 1)
    {
